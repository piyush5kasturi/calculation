...
import { useMaster } from "../../components/master/master.services";
...
export default function AddExpense({
  ...
  const { MasterMutation, isLoading, error, data, isError } = useMaster();
  ...
  useEffect(() => {
    if (data) {
      queryClient.removeQueries({ queryKey: ["master", "list"] });
      toggle(false);
    }
